      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-xl mx-8 relative">
            <input 
              type="text" 
              placeholder="Search for Furniture, Mattresses & more..." 
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full bg-gray-100 border border-transparent focus:bg-white focus:border-primary rounded-full py-2.5 pl-5 pr-12 outline-none transition-all duration-300" 
            />
            ...
            <div className="px-6 py-4 flex flex-col space-y-4">
              ...
              <form onSubmit={handleSearch} className="relative md:hidden w-full">
                <input 
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full bg-gray-100 rounded-full py-2.5 pl-5 pr-12 outline-none" 
                />
                <button type="submit" className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-primary">
                  <i className="fas fa-search text-lg"></i>
                </button>
